...
class App extends Component {
  ...
  addEmployeeData(){
    ...
    const lastName = document.getElementById(`customer_name`).value;
  ...
  updateEmployee(){
    ...
    this.state.editedproduct && (this.state.employeeList[edI].product = this.state.editedproduct)
    this.setState({
  ...
  renderHeader(){
    return(
      <header className="App-header">
        ...
        <h1 className="App-title">Welcome To Business Management System</h1>
      </header>
    )
  }
            ...
            <table className="table table-striped table-dark">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="centerAll">id</th>
                  <th scope="col" className="centerAll">customer_name</th>
                  <th scope="col" className="centerAll">customer_email</th>
                  <th scope="col" className="centerAll">product</th>
                  <th scope="col" className="centerAll">quantity</th>
              ...
              {this.state.employeeList.map((value, index)=>{
                    return(
                      this.state.editIndex !== index ? <tr>
                            ...
                            <td className="centerAll" id={index+2}>{value.id}</td>
                            <td className="centerAll" id={index+3}>{value.customer_name}</td>
                            <td className="centerAll" id={index+4}>{value.customer_email}</td>
                            <td className="centerAll" id={index+5}>{value.product}</td>
                            <td className="centerAll" id={index+6}>{value.quantity}</td>
                          ...
                          : <tr>
                          <th scope="row" id={index+1}>{index+1}</th>
                          <td className="centerAll" id={index+2+'edit'}><input type="text" defaultValue={value.id} onChange={this.updateFirstName}/></td>
                          <td className="centerAll" id={index+3+'edit'}><input type="text" defaultValue={value.customer_name} onChange={this.updateLastName}/></td>
                          <td className="centerAll" id={index+4+'edit'}><input type="text" defaultValue={value.customer_email} onChange={this.updateEmail} /></td>
                          <td className="centerAll" id={index+5+'edit'}><input type="text" defaultValue={value.product} onChange={this.updateproduct}/></td>
                          <td className="centerAll" id={index+6+'edit'}><input type="text" defaultValue={value.quantity}/></td>
  ...
  renderAddEmployee() {
    return(
      <div className="loginForm">
        ...
        <div className="form-group">
          <label >id</label>
          <input type="text" className="form-control" id="id" aria-describedby="emailHelp" placeholder="Enter id"/>
        </div>
        <div className="form-group">
          <label >customer Name</label>
          <input type="text" className="form-control" id="customer_name" aria-describedby="emailHelp" placeholder="Enter customer Name"/>
        </div>
        <div className="form-group">
          <label >Email address</label>
        ...
        <div className="form-group">
          <label >product</label>
          <input type="text" className="form-control" id="product" aria-describedby="emailHelp" placeholder="Enter product"/>
        </div>
        <div className="form-group">
          <label >quantity</label>
          <input type="text" className="form-control" id="product" aria-describedby="emailHelp" placeholder="Enter quantity"/>
        </div>
